...
function AppointPatientList() {
  ...
  const addMedicine = () => {
    PrivateAxios.post(`healthhistory/`+ health.id+`/medicine`,medicines).then((response) => {
      tog();
  ...
  return (
    <Container>
      ...
      <Modal isOpen={modal} toggle={toggle} centered={true} scrollable={true} size={"md"}>
        <ModalHeader toggle={toggle}>Add Prescription and Medicines</ModalHeader>
        <ModalBody>
          <>
      ...
      <Modal isOpen={mo} toggle={tog} centered={true} scrollable={true} size={"lg"}>
              ...
              <Row className="mt-5 mb-5">
                <Col sm={{ size: 6, offset: 3 }}>
                  ...
                  <Input
                      type="text"
                      id="medicineName"
                      onChange={(e) => { medHandleChange(e, "medicineName"); }}
                  ...
                  <FormGroup>
                    <Label for="duration">
                      Enter Medicine Duration
                    </Label>
                    <Input
                      type="text"
                      id="duration"
                        onChange={(e) => { medHandleChange(e, "duration"); }}
                   ...
                   <FormGroup>
                    ...
                    <FormGroup>
                      <Label for="medicineCharges">Enter Medicine Charges</Label>
                      <Input
                        type="number"
                        placeholder="Enter Here"
                        id="medicineCharges"
