...
function Schedule() {
    ...
    useEffect(() => {
        ...
        setDays({
            "sunday": JSON.parse(JSON.parse(localStorage.data).user.employee.doctor.days).sunday,
            "monday": JSON.parse(JSON.parse(localStorage.data).user.employee.doctor.days).monday,
            "tuesday": JSON.parse(JSON.parse(localStorage.data).user.employee.doctor.days).tuesday,
            "wednesday": JSON.parse(JSON.parse(localStorage.data).user.employee.doctor.days).wednesday,
            "thursday": JSON.parse(JSON.parse(localStorage.data).user.employee.doctor.days).thursday,
            "friday": JSON.parse(JSON.parse(localStorage.data).user.employee.doctor.days).friday,
            "saturday": JSON.parse(JSON.parse(localStorage.data).user.employee.doctor.days).saturday
        });
    }, []);
    ...
    const submitForm = (event) => {
        ...
        updateDoctorSchedule(JSON.parse(localStorage.data).user.employee.doctor.id,data,JSON.stringify(days))
          .then((response) => {
